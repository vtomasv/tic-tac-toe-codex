...
**Lifecycle**: `PLANNED` durante la reparación del bloque TDD domain de repetición/límite vacío;
vuelve a `IMPLEMENTING` solo después de Analyze H y T119.
