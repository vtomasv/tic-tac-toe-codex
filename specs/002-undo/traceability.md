...
| GATE-SWARM-001 | T128 | T129 | `scripts/swarm.test.mjs` | `2026-07-23 exit 1; E2E resume rejected planned RED tests and Markdown marker bypassed propagation` | 636d1aa8478688698a260abce2f44162cd9f363e | 4438b8f834630255a49b8bb5318fb82dab907ecf | VERIFIED |
...
| AC-US5-INTERACCION-001 | T131 | T086 | E2E compatibility | `tests/e2e/tic-tac-toe.spec.ts` | `AC-US4-RESPONSIVE-013 AC-US5-INTERACCION-001 evita superposición con once controles` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-DOMINIO-005 | T081 | T086 | Integration | `src/components/App.integration.test.tsx` | `AC-US5-DOMINIO-005 restaura las nueve celdas en la composición real` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-ESTADO-006 | T081 | T086 | Integration | `src/components/App.integration.test.tsx` | `AC-US5-ESTADO-006 restaura por separado el estado en la composición real` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-ESTADO-007 | T081 | T086 | Integration | `src/components/App.integration.test.tsx` | `AC-US5-ESTADO-007 muestra el turno del jugador cuya jugada se retira` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-DOMINIO-008 | T081 | T086 | Integration | `src/components/App.integration.test.tsx` | `AC-US5-DOMINIO-008 elimina una sola marca en la composición real` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-TERMINAL-009 | T082 | T086 | E2E | `tests/e2e/game.spec.ts` | `AC-US5-TERMINAL-009 recupera juego desde los tres estados terminales` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-HISTORIAL-010 | T082 | T086 | E2E | `tests/e2e/game.spec.ts` | `AC-US5-HISTORIAL-010 deshace repetidamente en el navegador` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-HISTORIAL-011 | T082 | T086 | E2E | `tests/e2e/game.spec.ts` | `AC-US5-HISTORIAL-011 llega al tablero inicial en el navegador` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-UNWANTED-012 | T082 | T086 | E2E | `tests/e2e/game.spec.ts` | `AC-US5-UNWANTED-012 conserva el tablero en Undo vacío` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-UNWANTED-013 | T082 | T086 | E2E | `tests/e2e/game.spec.ts` | `AC-US5-UNWANTED-013 conserva el status en Undo vacío` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-UNWANTED-014 | T082 | T086 | E2E | `tests/e2e/game.spec.ts` | `AC-US5-UNWANTED-014 mantiene Undo no disponible después del no-op` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-HISTORIAL-015 | T083 | T086 | E2E | `tests/e2e/game.spec.ts` | `AC-US5-HISTORIAL-015 crea un único punto por jugada legal en navegador` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-HISTORIAL-016 | T083 | T086 | E2E | `tests/e2e/game.spec.ts` | `AC-US5-HISTORIAL-016 ignora intento en celda ocupada para Undo` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-HISTORIAL-017 | T083 | T086 | E2E | `tests/e2e/game.spec.ts` | `AC-US5-HISTORIAL-017 ignora intento terminal para Undo` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-RESET-018 | T083 | T086 | E2E | `tests/e2e/game.spec.ts` | `AC-US5-RESET-018 reset deja tablero vacío en navegador` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-RESET-019 | T083 | T086 | E2E | `tests/e2e/game.spec.ts` | `AC-US5-RESET-019 reset restaura turno X en navegador` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-RESET-020 | T083 | T086 | E2E | `tests/e2e/game.spec.ts` | `AC-US5-RESET-020 reset impide recuperar la partida anterior` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-PUNTERO-021 | T084 | T086 | Integration | `src/components/App.integration.test.tsx` | `AC-US5-PUNTERO-021 clic deshace una sola jugada` | PENDING | PENDING | PENDING | PENDING |
| AC-US5-PUNTERO-022 | T084 | T086 | E2E | `tests/e2e/game.spec.ts` | `AC-US5-PUNTERO-022 toque real deshace una jugada legal` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-TECLADO-023 | T084 | T086 | Integration | `src/components/App.integration.test.tsx` | `AC-US5-TECLADO-023 Enter deshace una jugada en App` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-TECLADO-024 | T084 | T086 | Integration | `src/components/App.integration.test.tsx` | `AC-US5-TECLADO-024 Espacio deshace una jugada en App` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-FOCO-025 | T084 | T086 | Integration composition | `src/components/App.integration.test.tsx` | `AC-US5-FOCO-025 mantiene foco en Deshacer jugada después de Undo` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-FOCO-027 | T085 | T086 | E2E | `tests/e2e/game.spec.ts` | `AC-US5-FOCO-027 muestra contorno continuo al enfocar Deshacer jugada` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-A11Y-028 | T084 | T086 | Integration | `src/components/App.integration.test.tsx` | `AC-US5-A11Y-028 conserva nombre exacto en App` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-RESPONSIVE-032 | T085 | T086 | E2E | `tests/e2e/game.spec.ts` | `AC-US5-RESPONSIVE-032 evita overflow horizontal entre 320 y 1920 px` | PENDING | PENDING | PENDING | PENDING |
| AC-US5-RESPONSIVE-033 | T085 | T086 | E2E | `tests/e2e/game.spec.ts` | `AC-US5-RESPONSIVE-033 evita superposición de controles con zoom 200 por ciento` | PENDING | PENDING | PENDING | PENDING |
...
| AC-US5-VISUAL-034 | T085 | T086 | E2E | `tests/e2e/game.spec.ts` | `AC-US5-VISUAL-034 mantiene señal textual no cromática` | PENDING | PENDING | PENDING | PENDING |
...
- Tras incorporar T127, el prompt E2E volvió a detenerse porque trataba los RED T080–T085 como un
  baseline inesperado y escribió el marcador entre comillas Markdown, forma que el runner no
  propagó. T128/T129 repararon ambos contratos de reanudación sin tocar producto ni contratos;
  Analyze L dio GO y T130 autorizó continuar T086 desde la historia RED existente.
- El ensayo mínimo de T086 demostró que control, selector y callback vuelven verdes conjuntamente
  todos los flujos salvo anuncios; también dejó obsoleto el conteo legacy de diez botones. Plan y
  Tasks agrupan esa composición atómica, añaden T131 RED, conservan T094 para anuncios y retiran
  T087/T093/T101/T103/T104 sin reutilizar sus IDs.
