...
| AC-US1-ESTADO-008 | T036 | T042 | Component | `src/components/Board.test.tsx` | `AC-US1-ESTADO-008 identifica a X durante PLAYING_X` | `2026-07-14: FAIL — no se encontró el texto Turno de X` | PENDING | PENDING | PENDING | PLANNED |
| AC-US1-ESTADO-009 | T037 | T042 | Component | `src/components/Board.test.tsx` | `AC-US1-ESTADO-009 identifica a O durante PLAYING_O` | `2026-07-14: FAIL — no se encontró el texto Turno de O` | PENDING | PENDING | PENDING | PLANNED |
...
| AC-US2-DOMINIO-001 | T043 | T045 | Domain | `src/domain/game.test.ts` | `AC-US2-DOMINIO-001 detecta las ocho líneas ganadoras de X` | `2026-07-14: FAIL — WINNING_LINES no está exportado` | PENDING | PENDING | PENDING | PLANNED |
| AC-US2-DOMINIO-002 | T044 | T045 | Domain | `src/domain/game.test.ts` | `AC-US2-DOMINIO-002 detecta las ocho líneas ganadoras de O` | `2026-07-14: FAIL — WINNING_LINES no está exportado` | PENDING | PENDING | PENDING | PLANNED |
| AC-US2-ESTADO-003 | T038 | T042 | Component | `src/components/Board.test.tsx` | `AC-US2-ESTADO-003 identifica a X como ganador en WON_X` | `2026-07-14: FAIL — no se encontró el texto Ganó X` | PENDING | PENDING | PENDING | PLANNED |
| AC-US2-ESTADO-004 | T039 | T042 | Component | `src/components/Board.test.tsx` | `AC-US2-ESTADO-004 identifica a O como ganador en WON_O` | `2026-07-14: FAIL — no se encontró el texto Ganó O` | PENDING | PENDING | PENDING | PLANNED |
| AC-US2-DOMINIO-005 | T046 | T047 | Domain | `src/domain/game.test.ts` | `AC-US2-DOMINIO-005 resuelve DRAW en la novena jugada sin línea ganadora` | `2026-07-14: FAIL — se obtuvo PLAYING_O en vez de DRAW` | PENDING | PENDING | PENDING | PLANNED |
| AC-US2-ESTADO-006 | T040 | T042 | Component | `src/components/Board.test.tsx` | `AC-US2-ESTADO-006 identifica el resultado como empate en DRAW` | `2026-07-14: FAIL — no se encontró el texto Empate` | PENDING | PENDING | PENDING | PLANNED |
| AC-US2-UNWANTED-007 | T048 | T050 | Domain | `src/domain/game.test.ts` | `AC-US2-UNWANTED-007 conserva el tablero en estados terminales` | `2026-07-14: FAIL — la activación terminal modificó el tablero` | PENDING | PENDING | PENDING | PLANNED |
| AC-US2-UNWANTED-008 | T049 | T050 | Domain | `src/domain/game.test.ts` | `AC-US2-UNWANTED-008 conserva el estado terminal vigente` | `2026-07-14: FAIL — la activación terminal sustituyó el estado vigente` | PENDING | PENDING | PENDING | PLANNED |
...
| AC-US3-ESTADO-002 | T051 | T056 | Domain | `src/domain/game.test.ts` | `AC-US3-ESTADO-002 vacía las nueve celdas al reiniciar` | `2026-07-14: FAIL — RESET conservó marcas en el tablero` | PENDING | PENDING | PENDING | PLANNED |
| AC-US3-ESTADO-003 | T052 | T056 | Domain | `src/domain/game.test.ts` | `AC-US3-ESTADO-003 vuelve a PLAYING_X al reiniciar` | `2026-07-14: FAIL — RESET conservó un estado distinto de PLAYING_X` | PENDING | PENDING | PENDING | PLANNED |
| AC-US3-FOCO-004 | T053 | T056 | Component | `src/components/Board.test.tsx` | `AC-US3-FOCO-004 mueve el foco a la primera celda al reiniciar` | `2026-07-14: FAIL — el foco permaneció en Reiniciar partida` | PENDING | PENDING | PENDING | PLANNED |
...
| AC-US4-A11Y-010 | T057 | T060 | Component | `src/components/Board.test.tsx` | `AC-US4-A11Y-010 anuncia el jugador del nuevo turno` | `2026-07-14: FAIL — no existe una región de estado accesible para el nuevo turno` | PENDING | PENDING | PENDING | PLANNED |
| AC-US4-A11Y-011 | T058 | T060 | Component | `src/components/Board.test.tsx` | `AC-US4-A11Y-011 anuncia el resultado terminal` | `2026-07-14: FAIL — no existe una región de estado accesible para los resultados terminales` | PENDING | PENDING | PENDING | PLANNED |
| AC-US4-RESPONSIVE-012 | T055 | T056 | E2E | `tests/e2e/tic-tac-toe.spec.ts` | `AC-US4-RESPONSIVE-012 evita desplazamiento horizontal entre 320 y 1920 píxeles` | `2026-07-14: FAIL — Reiniciar partida no restauró la celda a vacía en el ancho de 320 px` | PENDING | PENDING | PENDING | PLANNED |
...
| AC-US4-VISUAL-014 | T041 | T042 | Component | `src/components/Board.test.tsx` | `AC-US4-VISUAL-014 comunica la información esencial sin depender del color` | `2026-07-14: FAIL — no se encontró texto para turno y resultado` | PENDING | PENDING | PENDING | PLANNED |
...
| AC-US4-TECLADO-016 | T054 | T056 | Component + E2E | `src/components/Board.test.tsx`; `tests/e2e/tic-tac-toe.spec.ts` | `AC-US4-TECLADO-016 reinicia mediante Enter y Espacio` | `2026-07-14: FAIL — Enter y Espacio no vaciaron el tablero en componente ni E2E` | PENDING | PENDING | PENDING | PLANNED |
...
| AC-US4-A11Y-019 | T059 | T060 | Component | `src/components/Board.test.tsx` | `AC-US4-A11Y-019 anuncia el turno de X al comenzar y reiniciar` | `2026-07-14: FAIL — no existe una región de estado accesible para el inicio y el reinicio` | PENDING | PENDING | PENDING | PLANNED |
